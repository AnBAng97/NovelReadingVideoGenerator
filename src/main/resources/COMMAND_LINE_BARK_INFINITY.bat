...
echo Executing --- "%CALL_COMMAND% --prompt_file %PROMPT_FILE% --output_dir %OUTPUT_DIR% --output_filename %OUTPUT_FILENAME% --history_prompt %HISTORY_PROMPT% --hoarder_mode true" ---

@rem enter commands
cmd /c "%CALL_COMMAND% --prompt_file %PROMPT_FILE% --output_dir %OUTPUT_DIR% --output_filename %OUTPUT_FILENAME% --history_prompt %HISTORY_PROMPT% --hoarder_mode true"
